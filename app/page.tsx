...
export function ChamuyoCheckApp({ leasingPage = false }: { leasingPage?: boolean } = {}) {
  ...
  return <div className={`appShell ${leasingPage ? 'leasingAppShell' : ''}`}>
    ...
    <aside className="sidebar">
      <div className="brand">{leasingPage ? <div><img className="leasingBrandLogo" src="/brand/leasing-scoring-logo.png" alt="Leasing Scoring" /><div className="tag">Transparencia financiera del leasing</div></div> : <><div className="shield">✓</div><div><div className="logo">CHAMUYO<span>CHECK</span></div><div className="tag">Finanzas · Estafas · Derecho</div></div></>}</div>
    ...
    <main className="main">
      <div className="mobileTopbar">
        <div className="mobileTopbarBrand">
          {leasingPage ? <img className="leasingMobileBrandLogo" src="/brand/leasing-scoring-logo.png" alt="Leasing Scoring" /> : <><div className="shield">✓</div><div className="authIntro"><div className="logo">CHAMUYO<span>CHECK</span></div><div className="tag">Finanzas · Estafas · Derecho</div></div></>}
        </div>
